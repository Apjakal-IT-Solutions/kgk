...
_original_get_date = Importer.get_date
...
# Apply the patch
Importer.get_date = patched_get_date

frappe.logger().info("[kgk_customisations] Patched Importer.get_date to handle time values in date fields")
